...
public class BodyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("auris", "ear", R.raw.auris));
        words.add(new Word("caput", "head", R.raw.caput));
        words.add(new Word("corpus", "body", R.raw.corpus));
        words.add(new Word("dexter", "right hand", R.raw.dexter));
        words.add(new Word("digitus", "finger", R.raw.digitus));
        words.add(new Word("genu", "knee", R.raw.genu));
        words.add(new Word("lingua", "tongue", R.raw.lingua));
        words.add(new Word("nasus", "nose", R.raw.nasus));
        words.add(new Word("oculus", "eye", R.raw.oculus));
        words.add(new Word("os", "mouth or face", R.raw.os));
        words.add(new Word("pectus", "breast or heart", R.raw.pectus));
        words.add(new Word("pes", "foot", R.raw.pes));

        WordAdapter wordAdapter = new WordAdapter(this, words, R.color.category_body);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView <?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    // we have audio focus
                    mediaPlayer = MediaPlayer.create(BodyActivity.this, words.get(position).getAudioResource());
                    mediaPlayer.start();
